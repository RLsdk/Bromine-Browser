...
content-blocking-section-top-level-description = Bromine supports - and it enables by default - Enhanced Tracking Protection in Strict mode. This is one of the most important settings in the browser, as it provides state partitioning, strict blocking lists and other neat privacy features. We do not recommend changing to other modes.

librewolf-etp =
    .label = Enhanced Tracking Protection
    .description = Bromine supports - and it enables by default - Enhanced Tracking Protection in Strict mode. This is one of the most important settings in the browser, as it provides state partitioning, strict blocking lists and other neat privacy features. We do not recommend changing to other modes.
...
librewolf-rfp-warning =
    .message = This feature is disabled because ResistFingerprinting is enabled. This means Bromine will force web content to display in a light theme.
